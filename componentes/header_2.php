        ...
        <div class="row d-flex justify-content-lg-center justify-content-between align-items-end me-0 w-100 g-0" id="nav1">
          ...
          <div class="col-3 col-sm-auto d-block d-lg-none">
            <nav class="mobile navbar navbar-expand-lg bg-body-light p-0 me-xxl-1 me-xxl-3">
              <div class="container-fluid">
                <button class="navbar-toggler" onclick="mudarIcon()" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="row g-0">
          <div class="col-12 px-0 banner">
            <?php foreach($banner as $b): ?>
              <img src="<?= $b["imagem"]; ?>" alt="" class="w-100">
            <?php endforeach; ?>
          </div>
        </div>
      </header>